...
namespace CleanArchitecture.Application.Features.Streamers.Commands.UpdateStreamer
{
    public class UpdateStreamerCommandHandler : IRequestHandler<UpdateStreamerCommand>
    {
        ...
        public UpdateStreamerCommandHandler(/*IStreamerRepository streamerRepository*/ IUnitOfWork unitOfWork, IMapper mapper, ILogger<UpdateStreamerCommandHandler> logger)
        {
        ...
        public async Task<Unit> Handle(UpdateStreamerCommand request, CancellationToken cancellationToken)
        {
            ...
            _logger.LogInformation($"Streamer {request.Id} se actualizó");
